...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture> implements IPictureService {
    ...
    public Picture upload(MultipartFile file, String userName) {
        ...
        String uri = ossClient.generatePresignedUrl(this.ossConfigProperties.getBucketName(), filePath, new Date(System.currentTimeMillis() + 3600 * 1000 * 24 * 365 * 50)).toString();
        picture.setUrl(uri);
    ...
    public void deleteAll(Set<Long> ids) {
        ids.forEach(id->{
            ...
            this.ossClient.deleteObject(picture.getBucketName(),picture.getDeleteUrl());
            this.removeById(id);
        });
